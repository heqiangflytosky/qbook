...
### 论文、资源检索
 ...
 - [arxiv-sanity：arxiv便捷预览版](https://arxiv-sanity-lite.com/)：我们都知道arxiv.org是一个非常大的预印本资源库，里面有大量的最新的论文，但缺点是浏览、搜索和排序不是很方便。这个库每天会更新大量的论文，如果只是通过手动搜索和浏览效率就太低了。所以这里提供了一个便捷预览版。
 -[网页版的arxiv](https://ar5iv.labs.arxiv.org/html/)在后面加上论文编号，可以网页浏览，结合翻译插件可以方便翻译成中文。    
